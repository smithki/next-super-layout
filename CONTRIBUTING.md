...
| ------------------------ | ----------------------------------------------------------------------------------------- |
| `yarn dev`               | Start building `next-super-layout` in development mode. |
| `yarn build`             | Build `next-super-layout` for production. |
| `yarn clean`             | Run cleaning scripts. |
| `yarn lint`              | Run the linter. |
| `yarn test`              | Run unit tests. |
| `yarn test:tree-shaking` | Test the component library for tree-shaking compatibility. |

## Opening a Pull Request

1. Open a pull request from your fork/branch to the upstream `main` branch of _this_ repository.
...
reported to the community leaders responsible for enforcement at [hello@iks.codes](mailto:hello@iks.codes).
